...
export default function Features() {
  return (
    <section className="space-y-16 p-4 lg:px-24 lg:py-16">
      {/* Header Section */}
      <div className="flex flex-col items-center justify-center space-y-2 text-center px-4 text-primary-900">
      ...
      <div className="flex flex-col items-center justify-center space-y-3 text-center text-primary-950">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {/* Tractors */}
        <Link
          className="flex flex-col items-center justify-center relative group overflow-hidden p-6 lg:py-12 rounded-xl border-2 border-primary-100 bg-white ring-transparent ring-2 hover:ring-primary-800"
          data-discover="true"
          to="/"
        >
          <div className="z-20 p-8 space-y-12 duration-300 absolute top-0 w-full h-full bg-white/50 backdrop-blur-md opacity-0 group-hover:opacity-100">
            ...
            <p className="text-lg">
              ...
              powerful engines, advanced transmissions, and a variety of attachments, our tractors can handle everything
              from plowing and tilling to hauling heavy loads and operating implements.
            </p>
          </div>
          <img
            src="/placeholder-tractor.jpg"
            alt="Tractor"
            className="h-40 lg:h-80 transition ease-in duration-200 scale-95 group-hover:scale-100 object-contain"
          />
          <p className="font-bold text-center lg:text-xl text-primary-900">Tractors</p>
        </Link>
        ...
        >
          ...
          <img
            src="/placeholder-harvester.jpg"
            alt="Combine Harvester"
            className="h-40 lg:h-80 transition ease-in duration-200 scale-95 group-hover:scale-100 object-contain"
          />
          <p className="font-bold text-center lg:text-xl text-primary-900">Combine Harvesters</p>
        </Link>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        ...
        >
          ...
          />
          <p className="font-bold text-center lg:text-xl text-primary-900">Land Preparation</p>
        </Link>
        ...
        >
          <div className="z-20 p-8 space-y-12 duration-300 absolute top-0 w-full h-full bg-white/50 backdrop-blur-md opacity-0 group-hover:opacity-100">
            ...
            <p className="text-base">
              Enhance the beauty and functionality of your property with our expert landscaping services. From designing
              and installing stunning gardens to maintaining your outdoor spaces, our team can transform your landscape.
              We offer a range of services, including lawn care, tree and shrub care, and irrigation system
              installation.
            </p>
          </div>
          <img
            ...
            className="transition ease-in duration-200 scale-95 group-hover:scale-100 h-20 lg:h-60 object-contain"
          />
          <p className="font-bold text-center lg:text-xl text-primary-900">Landscaping</p>
        </Link>
        ...
        >
          <div className="z-20 p-8 space-y-12 duration-300 absolute top-0 w-full h-full bg-white/50 backdrop-blur-md opacity-0 group-hover:opacity-100">
            ...
            <p className="text-base">
              ...
              selection, precise seeding, and efficient planting techniques. We use advanced equipment and techniques to
              ensure optimal seed placement and germination.
            </p>
          </div>
          <img
            ...
            className="transition ease-in duration-200 scale-95 group-hover:scale-100 h-20 lg:h-60 object-contain"
          />
          <p className="font-bold text-center lg:text-xl text-primary-900">Seeding &amp; Planting</p>
        </Link>
        ...
        >
          <div className="z-20 p-8 space-y-12 duration-300 absolute top-0 w-full h-full bg-white/50 backdrop-blur-md opacity-0 group-hover:opacity-100">
            ...
            <p className="text-base">
              ...
              products, including insecticides, fungicides, and herbicides, to safeguard your crops and maximize yields.
            </p>
          </div>
          <img
            ...
            className="transition ease-in duration-200 scale-95 group-hover:scale-100 h-20 lg:h-60 object-contain"
          />
          <p className="font-bold text-center lg:text-xl text-primary-900">Crop Protection</p>
        </Link>
        ...
        >
          <div className="z-20 p-8 space-y-12 duration-300 absolute top-0 w-full h-full bg-white/50 backdrop-blur-md opacity-0 group-hover:opacity-100">
            ...
            <p className="text-base">
              ...
              yields. Our services include timely harvesting, efficient threshing, and proper storage techniques. We use
              advanced equipment and techniques to minimize losses and ensure the highest quality produce.
            </p>
          </div>
          <img
            ...
            className="transition ease-in duration-200 scale-95 group-hover:scale-100 h-20 lg:h-60 object-contain"
          />
          <p className="font-bold text-center lg:text-xl text-primary-900">Harvesting, Threshing &amp; Storage</p>
        </Link>
        ...
        >
          <div className="z-20 p-8 space-y-12 duration-300 absolute top-0 w-full h-full bg-white/50 backdrop-blur-md opacity-0 group-hover:opacity-100">
            ...
            <p className="text-base">
              Post-harvesting activities are essential for preserving the quality and value of your crops. Our services
              include cleaning, drying, grading, and packaging to prepare your produce for market. We prioritize food
              safety and quality control to ensure that your products meet the highest standards.
            </p>
          </div>
          <img
            ...
            className="transition ease-in duration-200 scale-95 group-hover:scale-100 h-20 lg:h-60 object-contain"
          />
          <p className="font-bold text-center lg:text-xl text-primary-900">Post Harvesting</p>
        </Link>
      </div>
    </section>
  )
